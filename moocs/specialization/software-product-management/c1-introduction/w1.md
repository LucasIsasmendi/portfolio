...
Our brain encode the everyday things we do into habits so we can free space to learn new things, is a process call **Habituation**, is the way that we learn. Is not goot when it stop us to notice the problem taht are around us. Is hard to solve a problem that almost no one sees.  
...
Innovation is anything new and useful. Innovation is not about solo-genius, is about collective geniuses.
Innovative organizations are communities that have three capabilities:
- creative abrasion: being able to create a marketplace of ideas to debate and discuss. Innovation never happends if you don't have both diversity and conflict
- creative agility: being able to test and refine that portfolio of ideas with reflection and adjustment: discovery-driven, design thinking, run experiments
- creative resolution: doing decision making in a way that you can actually combine even opposing ideas to reconfigure them in new combinations to produce a solution that is new and useful.
