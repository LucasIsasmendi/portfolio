...
## Initials
Famous people are sometimes referred to by their initials, like MLK (Martin Luther King, Jr.) or JFK (John Fitzgerald Kennedy).
In these cases, the last letter is stressed:
- PBS [pi-biˈɛs]
- JFK [dʒeɪ-ɛfˈkeɪ]

Some letter names have more than one syllable, like W [ˈdʌb əәlˌju]. In these cases, only the stressed syllable is stressed: - BMW [bi-ɛm-ˈdʌb-әlˌju].

### [V7.5 — Word Stress and Initials](engl.io/avr)

### [A7.8 — Initials](engl.io/avt)
- CVS [si-viˈεs]
- PBS [pi-biˈεs]
- LA [εlˈeɪ] 
- DHL [di-eɪʧˈεl]

**More initials to work with:**
HBO[eɪʧ-biˈoʊ], JFK[ʤeɪ-εfˈkeɪ] RFK[ɑɹ-εfˈkeɪ], ING[aɪ-εnˈʤi], PNC[pi-εnˈsi], ABC[eɪ-biˈsi], TV[tiˈvi], AARP[eɪ-eɪ-ɑɹˈpi]

- Note some names that are abbreviated like this aren’t pronounced by saying the letters, but by making a word out of the letters, like NASA[ˈnæ səә].

> **Practice the stressed and unstressed syllables separately so you can focus on how they’re different.** Then put the whole word back together. When you break something down into smaller parts to practice, it’s always beneficial.

**Word of the Week Videos featured above:**
- Burrito
- Procedure
- Tomorrow
- Vacation
