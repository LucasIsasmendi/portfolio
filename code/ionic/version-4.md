...
## Examples
### EnAppd
**Activity chart for one-view-nutrition**
https://github.com/enappd/ionic-4-highcharts

**Mobile push notifications** https://github.com/enappd/ionic-4-push

**Anonymous Login** https://github.com/enappd/ionic-4-firebase-anonymous-login
...
### Examples
**Anonymus login**: 
https://github.com/enappd/ionic-4-firebase-anonymous-login
...
## CI
### GitLab
https://tphangout.com/angular-5-continuous-integration-with-gitlab/
...
#### Basics
https://www.joshmorony.com/e2e-end-to-end-testing-in-ionic-2-structuring-tests-with-page-objects/

https://medium.com/medialesson/end-to-end-e2e-tests-in-angular-application-using-protractor-3fd2501bb3c0

#### Advanced
https://angularfirebase.com/lessons/angular-testing-guide-including-firebase/#End-to-End-e2e-Testing-with-Protractor
...
### tool
#### HighChart
https://enappd.com/blog/adding-charts-in-ionic-4-apps-and-pwa-part-3/60/
