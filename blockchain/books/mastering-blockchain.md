...
A node that can exhibit arbitrary(unexpected or malicious) behavior is also known as a Byzantine node.
...
- In 1999 by Castro and Liskov who presented the Practical Byzantine Fault Tolerance (PBFT) algorithm solves the experiment.
...
- Permissioned ledger (agreement protocol)
